package social.life.cn.download;
...
public class DownloadManager {
	...
	public synchronized void startDownload(String url, String path, String fileName, social.life.cn.download.DownloadTaskListener listener) {
		if (!social.life.cn.util.SAFUtils.hasSdcard()) {
			social.life.cn.util.ToastUtils.show(mContext, "未发现SD卡");
			return;
		}
	...
	public synchronized void continueDownload(String url, String path, String fileName, social.life.cn.download.DownloadTaskListener listener) {
		task = null;
		try {
