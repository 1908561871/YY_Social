...
public class ResourceUtils {
    ...
    /**
     * same to {@link zwb.social.util.ResourceUtils#geFileFromAssets(Context, String)}, but return type is List<String>
     *
     * @param context
     * @param fileName
     * @return
    ...
    /**
     * same to {@link zwb.social.util.ResourceUtils#geFileFromRaw(Context, int)}, but return type is List<String>
     * 
     * @param context
     * @param resId
     * @return
